...
import com.example.brightways.UI.ProductDetailsWomen;
...
public class WomenFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton fab = (FloatingActionButton) view.findViewById(R.id.fab_women);
        ...
        recyclerView = view.findViewById(R.id.recycler_menu_women);
                    ...
                    protected void onBindViewHolder(@NonNull ProductViewHolder holder, int position, @NonNull final Products model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                Intent intent = new Intent(getContext(), ProductDetailsWomen.class);
